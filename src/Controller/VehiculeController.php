...
class VehiculeController extends AbstractController
{
    ...
    /**
     * @Route("/", name="vehiclule_index")
     */
    public function vehicule_searsh(VehiculeRepository $vehiculeRepository, Request $request)
    {
        $result= null;
        $vehiculeSearsh= $request->request->get('vehicule_searsh');
        if($vehiculeSearsh){
            $result= $vehiculeRepository->findByBrandAndModel($vehiculeSearsh);
        }else{
